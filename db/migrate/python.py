data = [
    ...
    },
    {
        ...
        "highway_mpg": 98,
        "make": "bmw",
        "model": "i4 m50 gran coupe (19 inch wheels)",
        "transmission": "a",
        "year": 2022
    },
    {
    ...
    },
    {
        ...
        "highway_mpg": 99,
        "make": "nissan",
        "model": "leaf (40 kw-hr battery pack)",
        "transmission": "a",
        "year": 2022
    },
    {
...
# Adicionando os campos 'price' e 'daily_rental_price'
df['price'] = df.apply(lambda row: 30000 + (row['city_mpg'] * 50), axis=1)  # Um cálculo arbitrário para o preço
df['daily_rental_price'] = df['price'] * 0.001  # Rentabilidade diária (0.1% do valor)

# Salvando os dados no banco de dados
df.to_json('db/car_data2.json', orient='records', indent=4)
